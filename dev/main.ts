...
// markdown-it中用于插入vue react组定义组件的插件
...
import './element-plus/element-theme.scss';
// markdown-it中用于插入vue react组定义组件的插件样式
...
createApp(App).use(MdEditor).use(elementPlus).mount('#app');
